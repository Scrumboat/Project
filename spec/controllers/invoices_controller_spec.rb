  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved invoice as @invoice" do
        ...
        post :create, {:invoice => { "nimi" => "invalid value" }}, valid_session
        assigns(:invoice).should be_a_new(Invoice)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested invoice" do
        ...
        Invoice.any_instance.should_receive(:update_attributes).with({ "nimi" => "MyString" })
        put :update, {:id => invoice.to_param, :invoice => { "nimi" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the invoice as @invoice" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Invoice.any_instance.stub(:save).and_return(false)
        put :update, {:id => invoice.to_param, :invoice => { "nimi" => "invalid value" }}, valid_session
        assigns(:invoice).should eq(invoice)
      end
